...
summary(values(altitude_rio)) # gera estatisticas resumidas do raster

res(altitude_rio) # verifica a resolucao dos pixel do raster
...
rede_viaria_rio <- st_read("C:/Users/Juciano Rodrigues/Documents/declive_roads/rede_viaria_rio.shp")

# Criando o mapa em html


tmap_mode("view")
tmap_options(basemaps = leaflet::providers$CartoDB.Positron) #mapa base
mapadeclives =
  tm_shape(rede_viaria_rio) +
  tm_lines(
    col = "declive_class",
    palette = palredgreen, #palete de cores
